...
public class LuauForeachStatementImpl extends ASTWrapperPsiElement implements LuauForeachStatement {

  public LuauForeachStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
