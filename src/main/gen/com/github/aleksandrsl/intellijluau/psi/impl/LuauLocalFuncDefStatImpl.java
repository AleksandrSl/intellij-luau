...
public class LuauLocalFuncDefStatImpl extends ASTWrapperPsiElement implements LuauLocalFuncDefStat {

  public LuauLocalFuncDefStatImpl(@NotNull ASTNode node) {
    super(node);
  }
